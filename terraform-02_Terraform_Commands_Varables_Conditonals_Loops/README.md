...
An argument named "key_name" is not expected here. Did you mean "key_name"?
...
variable "s3_bucket_name" {
  default = "oktay-s3-bucket-variable-addwhateveryouwant"
}
...
```tf
variable "s3_bucket_name" {
#   default     = "oktay-new-s3-bucket-addwhateveryouwant"
}
```
...
```bash
terraform plan -var="s3_bucket_name=oktay-new-s3-bucket-2"
```
...
- Create a file name `oktay.tfvars`. Add the followings.

```bash
s3_bucket_name = "oktay-tfvar-bucket"
```

- Run the command below.

```bash
terraform plan --var-file="oktay.tfvars"
```

- Create a file named `oktay.auto.tfvars`. Add the followings.

```bash
s3_bucket_name = "oktay-auto-tfvar-bucket"
```
